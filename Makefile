...
SOURCES=src/thurs.control.cpp src/thurs.input.cpp src/thurs.renderer.cpp src/thurs.surface.cpp src/thurs.color.cpp src/thurs.os.cpp src/controls/thurs.control.button.cpp src/controls/thurs.control.progressbar.cpp src/thurs.skin.cpp src/thurs.window.cpp src/controls/thurs.control.slider.cpp src/controls/thurs.control.listbox.cpp src/thurs.scrollbar.cpp src/controls/thurs.control.checkbox.cpp
